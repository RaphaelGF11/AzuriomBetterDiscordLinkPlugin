        ...
        <div class="card">
            <div class="card-body">
                ...
                @if($discordLoginEnabled ?? false)
                    ...
                    <div class="d-grid">
                        <a href="{{ route('discord-integration.redirect', ['intent' => 'login']) }}" class="btn btn-primary d-block" style="background-color: #5865F2; border-color: #5865F2;">
                            <i class="bi bi-discord"></i> {{ trans('discord-integration::messages.login.button') }}
                        </a>
                    </div>
                @endif
            </div>
